...
function Carousel() {
  ...
  return (
    <>
      {/* A classe aqui é dinâmica, baseada no state */}
      <div className={`carousel ${carouselClass}`}>
        <div className="list">
          {/* Mapeamos o array "items" do state para criar os slides */}
          {items.map((item) => (
            <div className="item" key={item.id}>
              ...
              <div className="introduce">
                ...
                {/* O clique é definido AQUI, no JSX */}
        ...
        <div className="arrows">
          {/* Os cliques são definidos AQUI e usam o state "isClickDisabled" */}

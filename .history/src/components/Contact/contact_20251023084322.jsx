...
const MyPopup = () => (
  <Popup 
    trigger={<button className="button-popup"> Contato </button>} 
    modal 
    animation="fade" 
  ...
  >
    {close => (
      <div>
        {/* Botão de Fechar ("x") usa a classe .popup-close-button */}
        <button 
          onClick={close} 
        ...
        {/* Cabeçalho usa a classe .popup-header */}
        ...
        {/* Container dos Ícones usa a classe .icon-container */}

...
const ContactStyles = () => (
  <style>{`
    /* Estilos da Sobreposição (Overlay)
      - Começa invisível (opacity: 0) e não clicável
    ...
    */
    ...
    /* - Quando o popup está aberto, o overlay fica visível
    */
    .custom-overlay.open {
      opacity: 1;
      visibility: visible;
    ...
    /* Estilos do Conteúdo do Modal (Animação principal)
      - Começa invisível e levemente reduzido
      - Transição suave de opacidade e escala
    */
    .custom-modal-content {
      ...
      z-index: 1000;
      /* Removemos estilos de fundo/borda, 
         pois o .popup-container cuidará disso */
    }

    /* - Quando o popup está aberto, o modal aparece no tamanho normal
    */
    ...
    /* Seus estilos originais do popup */
    .popup-container {
    ...
    .popup-close-button {
      ...
      border: none;
      background: none;
      font-size: 1.8rem; /* Aumentado para ser mais fácil de clicar */
      cursor: pointer;
      color: #ffffff;
      line-height: 1;
 ...
 * Renderiza o componente de Contato e os Estilos
 */
  ...
  return (
    <>
      ...
      <div style={{ 
        ...
        alignItems: 'center', 
        height: '100vh', 
        backgroundColor: '#f0f2f5' // Um fundo de app de exemplo
      }}>
        <Contact />
      </div>
    </>
